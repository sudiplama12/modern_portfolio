              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-white/80 text-sm">
                        Hi! I'm Sudip's AI assistant. I can help answer
                        questions about his projects, skills, experience,
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      Tell me about Sudip's projects
                    </Badge>
                  ...
                  {[
                    {
                      ...
                      link: "https://github.com/sudiplama12",
                    },
                    {
                      name: "LinkedIn",
                      icon: "💼",
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-white/60">
              © 2026 Sudip Lama. Crafted with using Next.js & Three.js.
            </div>
