    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          ...
          >
            I create modern, responsive, and futuristic web experiences
            using Next.js, React, Tailwind CSS, Node.js, and AI-powered
            technologies.
          </motion.p>
          ...
          >
            {[
              ...
              <div
                key={skill}
                className="px-4 py-2 rounded-full glass-morphism border border-white/10 text-white/70 text-sm hover:text-cyan-400 transition-colors"
              >
                {skill}
              </div>
            ))}
